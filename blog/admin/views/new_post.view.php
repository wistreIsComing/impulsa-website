                            ...
                            <div class="email-compose-fields">
                                <div class="to">
                                    <div class="form-group row pt-0">
                                        ...
                                        <div class="col-md-11">
                                            <input type="text" name="titulo" id="inputtext3" class="form-control" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="to asd">
                                ...
                                <div class="to cc">
                                    <div class="form-group row pt-2">
                                        ...
                                        <div class="col-md-11">
                                            <input type="text" name="video" id="inputtext3" class="form-control">
                                        </div>
                                    </div>
                                </div>
                                <div class="subject">
                                    <div class="form-group row pt-2">
                                        ...
                                        <div class="col-md-11">
                                            <input class="form-control" name="extracto" type="text" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="subject">
                            ...
                            <div class="email editor">
                                <div class="col-md-12 p-0">
                                    <div class="form-group">
                                        ...
                                        <textarea class="form-control" id="summernote" name="texto" rows="6" placeholder="Write Descriptions"></textarea>
                                    </div>
                                </div>
