                ...
                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                    <form class="gform pure-form pure-form-stacked" method="post" enctype="multipart/form-data" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>">
                        <div class="page-header">
                            ...
                            <input type="hidden" value="<?php echo $users['persona_id']; ?>" name="id">
                                <div class="to cc">
                                    <div class="form-group row pt-2">
                                        <label class="col-md-1 control-label">Nombre:</label>
                                        <div class="col-md-11">
                                            <input type="text" name="nombre" id="inputtext3" class="form-control" value="<?php echo $users['persona_nombre']; ?>" required>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="email action-send">
                                    <div class="col-md-12 ">
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-secondary btn-space" type="button" href="<?php echo RUTAADMIN; ?>/coworkers.php"><i class="icon s7-close"></i> Cancelar</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
